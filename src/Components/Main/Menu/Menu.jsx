...
const Menu = () => {
  ...
  return (
    <div className={s.menu}>
        ...
        <NavLink className={s.menu_links} to='/gifs'><MenuOption url={'https://pbs.twimg.com/profile_images/1351720980972933122/I3MnYUdm_400x400.jpg'} text={'DISLIKED'} /></NavLink>
